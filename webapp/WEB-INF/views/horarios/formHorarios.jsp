...
<html lang="en">
	...
	<jsp:include page="./../includes/menu.jsp"/>
		...
		<div class="container theme-showcase" role="main">
			...
			<form:form action="${pageContext.request.contextPath}/horarios/save" method="POST" modelAttribute="horario">
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							<label for="idPelicula" class="control-label">Pelicula</label>
							<form:select path="pelicula.id" class="form-control">							    
						      <form:options items="${peliculas}" itemValue="id" itemLabel="titulo"/>
							</form:select>
						</div>
					</div>
				</div>
				<div class="row"> 
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							<form:select items="${salas}" id="sala" path="sala" class="form-control"/>
						</div> 
					</div>
